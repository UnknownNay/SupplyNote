...
public class frame_editSupplier extends javax.swing.JFrame {
    ...
    //Deklarasi Variabel
    koneksi dbsetting;
    String driver,database, user, pass, namaSupplier_awal;
    Object tabel;
    ...
    private void settableload(){
        ...
        try{
            ...
            String SQL = "select nama_supplier, no_telepon,"
                    + " email, lokasi, negara from t_supplier";
    ...
    private void tampil_field(){
        ...
        txt_namaSupplier.setText(String.valueOf(tableModel.getValueAt(row, 0)));
        txt_notelp.setText(String.valueOf(tableModel.getValueAt(row, 1)));
        txt_email.setText(String.valueOf(tableModel.getValueAt(row, 2)));
        txt_lokasi.setText(String.valueOf(tableModel.getValueAt(row, 3)));
        txt_negara.setText(String.valueOf(tableModel.getValueAt(row, 4)));
    }
    ...
    private void tabel_supplierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_supplierMouseClicked
        ...
        this.namaSupplier_awal = txt_namaSupplier.getText();
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        try {
            ...
            String sqlCariKode = "SELECT kode_supplier FROM t_supplier "
                    + "WHERE nama_supplier = ?";

            PreparedStatement pst = kon.prepareStatement(sqlCariKode);
            pst.setString(1, namaSupplier_awal);
            ...
            if(resKode.next()){
                ...
                JOptionPane.showMessageDialog(null, "Supplier tidak ditemukan!", "Error", JOptionPane.ERROR_MESSAGE);
                System.out.println(namaSupplier);
                System.out.println(namaSupplier_awal);
